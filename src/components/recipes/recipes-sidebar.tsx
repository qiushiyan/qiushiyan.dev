            ...
            <Collapsible defaultOpen={true}>
              <CollapsibleTrigger asChild>
                <div className="group relative mb-3 flex items-center">
                  <div className="flex h-8 min-w-8 flex-1 items-center gap-2 overflow-hidden rounded-md px-1.5 text-sm font-medium outline-hidden ring-ring transition-all hover:bg-accent hover:text-accent-foreground focus-visible:ring-2">
                  ...
                  <Button
                    variant="ghost"
                    className="absolute right-1 size-6 rounded-md p-0 ring-ring transition-all focus-visible:ring-2 group-data-[state=open]:rotate-90"
                  >
